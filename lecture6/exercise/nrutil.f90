MODULE nrutil
  USE nrtype
  IMPLICIT NONE
  INTEGER(KIND=I4B), PARAMETER :: NPAR_ARTH=16,NPAR2_ARTH=8
  INTEGER(KIND=I4B), PARAMETER :: NPAR_GEOP=4,NPAR2_GEOP=2
  INTEGER(KIND=I4B), PARAMETER :: NPAR_CUMSUM=16
  INTEGER(KIND=I4B), PARAMETER :: NPAR_CUMPROD=8
  INTEGER(KIND=I4B), PARAMETER :: NPAR_POLY=8
  INTEGER(KIND=I4B), PARAMETER :: NPAR_POLYTERM=8
